...
interface ChatbotSourcesLayoutProps {
  chatbotId: string;
  type: "files" | "text" | "websites" | "knowledge";
}

export function ChatbotSourcesLayout({ chatbotId, type }: ChatbotSourcesLayoutProps) {
  // Mock chatbot data
  const chatbot = {
    id: chatbotId,
  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      {/* Header - Same as KnowledgeCreationLayout but with chatbot breadcrumb */}
