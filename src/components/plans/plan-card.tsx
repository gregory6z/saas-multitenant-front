 ...
 */
export const PlanCard = React.memo(({ plan, isPopular, isCurrent, hasActiveSubscription }: PlanCardProps) => {
      ...
      <CardHeader className="text-center pb-4">
        ...
        <div className="space-y-2">
          <div className="text-3xl font-bold">
            ...
            <span className="text-lg font-normal text-muted-foreground">{t("plans.perMonth")}</span>
          </div>
          <div className="h-6">
            {plan.interval === "year" && (
